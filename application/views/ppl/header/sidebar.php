<ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?php if ($halaman == 'pemilik_kandang') { echo 'active'; } else{ echo '';} ?>">
        <a class="nav-link" href="<?= base_url(); ?>ppl/Pemilik_kandang/index">
            <i class="fas fa-fw fa-home"></i>
    ...
    <li class="nav-item <?php if ($halaman == 'persetujuan') { echo 'active'; } else{ echo '';} ?>">
        <a class="nav-link" href="<?= base_url(); ?>ppl/Persetujuan/index">
            <i class="fas fa-fw fa-home"></i>
